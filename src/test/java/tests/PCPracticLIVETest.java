...
public class PCPracticLIVETest extends BaseTest {

    @Test
    public void RegTest() throws InterruptedException{
        PCPracticLIVEHelper.RegistracijaH();
        Thread.sleep(4000);
    }

    @Test
    public void LoginTest() throws InterruptedException{
        PCPracticLIVEHelper.LoginH();
        Thread.sleep(4000);
    }

    @Test
    public void LicnoKMIPouzeceTest() throws InterruptedException{
        PCPracticLIVEHelper.LicnoIPouzece();
        Thread.sleep(4000);
    }

    @Test
    public void LicnoKMIPlatnaKarticaTest() throws InterruptedException{
        PCPracticLIVEHelper.LicnoIPlatnaKH();
        Thread.sleep(4000);
    }

    @Test
    public void LicnoKMIPredracunTest() throws InterruptedException{
        PCPracticLIVEHelper.LicnoIPredracunH();
        Thread.sleep(4000);
    }
