...
public class MishelHelperLIVE extends BaseHelper{

    public static void RegHelper() throws InterruptedException {
        String url = "https://mishelfashion.me/";
        driver.navigate().to(url);
        driver.get("https://mishelfashion.me/");
    ...
    public static void Shopping() throws InterruptedException{
        ...
        Muskarci.click();
        WebElement Aksesoari = driver.findElement(By.xpath("/html/body/div[1]/main/div[2]/div/div/div/div/a[3]/div/img"));
        Aksesoari.click();
